    ...
    return (
        <div className=''>
            ...
            <div className='md:flex flex-wrap md:space-x-5 space-y-5 md:space-y-0 mt-10 justify-between'>
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div className='space-y-3'>
                            <p class="text-sm text-[#707071] dark:text-gray-400">GitHub stars</p>
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div className='space-y-3'>
                            <p class="text-sm text-[#707071] dark:text-gray-400">GitHub clones</p>
            ...
            <div className='md:flex justify-between md:space-x-10 mt-10 space-y-10 md:space-y-0'>
                <div id='communitymetricsbox' className='md:w-1/2 border-[#202021] hover:border-white border-4 rounded-lg p-6'>
                    <div className='flex justify-between items-center'>
                        <h1 className='text-xl'>Community metrics</h1>
                        <svg className='w-10 h-10' viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#ffffff" d="M3 3a2 2 0 1 1 4 0a2 2 0 0 1-4 0Zm2-1a1 1 0 1 0 0 2a1 1 0 0 0 0-2Zm4.779 2.584a2 2 0 1 1 2.442-3.168A2 2 0 0 1 9.78 4.584ZM11 2a1 1 0 1 0 0 2a1 1 0 0 0 0-2ZM2.5 6h2.67c-.11.313-.17.65-.17 1H2.5a.5.5 0 0 0-.5.5c0 .817.325 1.423.838 1.835c.236.19.519.343.839.455a2.5 2.5 0 0 0-.532.868a3.733 3.733 0 0 1-.933-.543C1.46 9.51 1 8.616 1 7.5A1.5 1.5 0 0 1 2.5 6Zm3.768 0a2 2 0 1 0 3.466 2a2 2 0 0 0-3.466-2Zm1.508.025A1.003 1.003 0 0 1 9 7a1 1 0 1 1-1.224-.975Zm5.386 3.31c-.236.19-.519.343-.839.455a2.5 2.5 0 0 1 .531.868c.34-.139.655-.32.934-.543C14.54 9.51 15 8.616 15 7.5A1.5 1.5 0 0 0 13.5 6h-2.67c.11.313.17.65.17 1h2.5a.5.5 0 0 1 .5.5c0 .817-.325 1.423-.838 1.835ZM10.5 10a1.5 1.5 0 0 1 1.5 1.5c0 1.116-.459 2.01-1.212 2.615C10.047 14.71 9.053 15 8 15c-1.053 0-2.047-.29-2.788-.885C4.46 13.51 4 12.616 4 11.5A1.496 1.496 0 0 1 5.5 10h5Zm0 1h-5a.5.5 0 0 0-.5.5c0 .817.325 1.423.838 1.835C6.364 13.757 7.12 14 8 14c.88 0 1.636-.243 2.162-.665c.513-.412.838-1.018.838-1.835a.5.5 0 0 0-.5-.5Z" />
                        </svg>
                    </div>
                    <div className='text-xs mt-4 text-[#737378]'>Community metrics include data related to adoption, user base, social audience and outreach.</div>
                    <div className='flex space-x-3 mt-5'>
                        <span
                            class="inline-flex items-center justify-center rounded-full bg-[#737378] px-2.5 py-0.5 text-[#000000]"
                        >
                ...
                <div id='networkmetricsbox' className='md:w-1/2 border-[#202021] hover:border-white border-4 rounded-lg p-6'>
                    <div className='flex justify-between items-center'>
                        <h1 className='text-xl'>Network metrics</h1>
                        <svg className='w-10 h-10' viewBox="0 0 2048 2048" xmlns="http://www.w3.org/2000/svg">
                            <path fill="currentColor" d="M1836 517q42 87 63 184t21 195q0 131-36 252t-102 227t-162 190t-212 141v86H768v128h256v128H384v-128h256v-128H0V896h128q0-124 32-238t90-214t140-181t181-140t214-91t239-32q130 0 252 36t227 102t190 162t141 212h2v5zm-147-5q-73-127-187-217t-254-134q48 78 77 169t47 182h317zm103 384q0-132-44-256h-356q16 128 16 255t0 257h340q44-124 44-256zm-512 0q0-65-4-128t-12-128H784q-8 64-12 127t-4 129h512zm-256-763q-29 0-55 21t-49 56t-41 78t-33 85t-25 79t-15 60h436q-5-23-15-60t-24-79t-33-85t-41-77t-49-56t-56-22zm-224 28q-140 43-254 133T359 512h317q17-90 46-181t78-170zM300 640q-44 124-44 256h384q0-65 4-128t12-128H300zM128 1664h1152v-640H128v640zm1280-103q88-51 159-122t123-159h-282v281z" />
                        </svg>
                    </div>
                    <div className='text-xs mt-4 text-[#737378]'>Network metrics include data related to Waku's node</div>
                    <div className='flex space-x-3 mt-5'>
                        <span
                            class="inline-flex items-center justify-center rounded-full bg-[#737378] px-2.5 py-0.5 text-[#000000]"
                        >
