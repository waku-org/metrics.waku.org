...
export default function Ecosystem() {
                        ...
                        <div className='mt-4'>
                            <form className='space-y-3'>
                                <label>
                                    ...
                                    <svg className='w-14 h-14 bg-black rounded-full p-2' viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill="#ffffff" d="M14 7.5a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Zm-1 0a.5.5 0 1 0-1 0a.5.5 0 0 0 1 0ZM3 6a3 3 0 0 1 3-3h8a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V6Zm3-2a2 2 0 0 0-2 2v8c0 .373.102.722.28 1.02l4.669-4.588a1.5 1.5 0 0 1 2.102 0l4.67 4.588A1.99 1.99 0 0 0 16 14V6a2 2 0 0 0-2-2H6Zm0 12h8c.37 0 .715-.1 1.012-.274l-4.662-4.58a.5.5 0 0 0-.7 0l-4.662 4.58A1.99 1.99 0 0 0 6 16Z" />
                                    </svg>
                                    <input type="file" class="hidden" name="file1" />

                                </label>
                                <input className='border-[#2c2c2c3e] border-2 w-full rounde -lg p-2 text-sm border-2 rounded-lg' placeholder='Project name' />
                                <br />
                                <textarea type='paragraph' className='border-[#2c2c2c3e] align-top w-full h-20 border-2 rounded-lg p-2 text-sm' placeholder='Project description' />
                                <br />
                                <input className='border-[#2c2c2c3e] border-2 w-full rounde -lg p-2 text-sm border-2 rounded-lg' placeholder='Project URL' />
                                <br />
                                <div className='flex justify-end'>
                                    <button className='bg-black rounded-lg text-white p-2'>Add project</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <path fill="#000000" d="M216 48h-40v-8a24 24 0 0 0-24-24h-48a24 24 0 0 0-24 24v8H40a8 8 0 0 0 0 16h8v144a16 16 0 0 0 16 16h128a16 16 0 0 0 16-16V64h8a8 8 0 0 0 0-16ZM96 40a8 8 0 0 1 8-8h48a8 8 0 0 1 8 8v8H96Zm96 168H64V64h128Zm-80-104v64a8 8 0 0 1-16 0v-64a8 8 0 0 1 16 0Zm48 0v64a8 8 0 0 1-16 0v-64a8 8 0 0 1 16 0Z"/>
</svg>
<svg className='w-7 h-7 rounded-xl p-1 hover:bg-yellow-200' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path fill="#000000" d="M5 19h1.4l8.625-8.625l-1.4-1.4L5 17.6V19ZM19.3 8.925l-4.25-4.2l1.4-1.4q.575-.575 1.413-.575t1.412.575l1.4 1.4q.575.575.6 1.388t-.55 1.387L19.3 8.925ZM17.85 10.4L7.25 21H3v-4.25l10.6-10.6l4.25 4.25Zm-3.525-.725l-.7-.7l1.4 1.4l-.7-.7Z"/>
</svg>
                    </div>
                </div>
